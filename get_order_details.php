    ...
    <style>
        ...
        * {
        ...
        .order-details-container {
            ...
            scrollbar-color: var(--primary) rgba(255, 126, 179, 0.1);
        }
        ...
        .detail-row {
            ...
            padding: 0.4rem 0;
            border-bottom: 1px dashed rgba(255, 126, 179, 0.1);
            font-size: 0.9rem;
        }
...
<body>
    ...
    <form class="status-form" method="POST" action="admin_orders.php">
